...
func jvpLinearFunc(x: Float) -> Float {  // TODO: add @nondiff when attribute is upstreamed.
  return (x, { 2 * $0 })
}

@transposing(linearFunc, wrt: 0) // ok
func jvpLinearFunc(t: Float) -> Float {  // TODO: add @nondiff when attribute is upstreamed.
  return 2 * t
}
